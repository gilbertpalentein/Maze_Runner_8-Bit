...
def displaySettingsSeleciton(screen, screen_size, choice, bg_colour, a_colour, na_colour, grid_size, side_length):
	...
	if choice == 0:
		...
		displayMessage("Escape", na_colour, screen, 30, screen_size, screen_size[1]*4//6, mode_text_rect)
		...
		displayMessage(grid_text, na_colour, screen, 30, screen_size, screen_size[1]*2//6)
		displayMessage(side_text, na_colour, screen, 30, screen_size, screen_size[1]*3//6)
		displayMessage("Escape", a_colour, screen, 30, screen_size, screen_size[1]*4//6, mode_text_rect)
		displayMessage("Return", na_colour, screen, 30, screen_size, screen_size[1]*5//6)
	elif choice == 3:
		displayMessage("Settings", na_colour, screen, 60, screen_size, screen_size[1]//6)
		displayMessage(grid_text, na_colour, screen, 30, screen_size, screen_size[1]*2//6)
...
def startScreen():
	...
	while carryOn:
		...
		if Settings:
			grid_size, side_length,  = settingsMenu(screen, screen_size, WHITE, GOLD, BLACK, cooldown,\
	...
	return Run, grid_size, side_length
